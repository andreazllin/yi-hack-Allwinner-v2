...
export const StaticIpPage: FunctionComponent = () => {
	...
	return (
		<Stack gap="md">
			...
			>
				...
				frontend, and the settings can only be undone over SSH or by resetting
				the camera.
			</Alert>
			<Card withBorder>
				<Stack gap="md">
			...
			>
				<Stack gap="md">
					<Text size="sm">
						...
						come back on your network and this frontend will be unreachable.
					</Text>
					<Group justify="flex-end">
